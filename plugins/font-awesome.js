...
import { faEye, faVolumeUp, faHandPaper, faUnlink, faUtensils, faCogs, faUser,
  ...
  faSitemap, faImages, faListAlt, faFileSignature, faFlask, faSearch } from '@fortawesome/pro-regular-svg-icons';
...
library.add(faEye, faVolumeUp, faHandPaper, faUnlink, faUtensils, faCogs, faUser,
  ...
  faSitemap, faImages, faListAlt, faFileSignature, faFlask, faSearch);
