<template>
    <div class="pageContent">
        ...
        <h1> Donate <i class="fa fa-heart-o categoryIcon"> </i> </h1>
        ...
        <h3> Options </h3>
        <ul>
          <li><b>Patreon</b> - <ext-link href="http://patreon.com/effectindex">Effect Index Patreon</ext-link></li>
          <li><b>Paypal</b> - wtfaregirlylaps@gmail.com</li>
