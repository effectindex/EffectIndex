<template>
    <div>
        ...
        <form @submit.prevent="submit">
            ...
            <label> Roles </label>
            <input type="checkbox" v-model="user.scope.admin" /> Admin <br />
            <input type="checkbox" v-model="user.scope.editor" /> Editor <br />
    ...
    export default {
        ...
        methods: {
            async submit() {
                ...
                try {
                    let response = await this.$axios.$post('/api/users/' + this.user._id, { user });
