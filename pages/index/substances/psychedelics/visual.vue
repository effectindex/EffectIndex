<template>
  <div class="pageContent">
    <div>
      ...
      <p style="padding-left: 2em;"> LSD, Psilocybin mushrooms, DMT, Ayahuasca, mescaline, 5-MeO-MiPT, 2C-B, LSA, AL-LAD, ALD-52, 1P-LSD, 2C-B-Fly, 2C-C, 2C-D, 2C-E, 2C-P, 4-AcO-DMT, 4-HO-MET, 4-HO-MiPT, 5-MeO-DMT, DPT, and DOC. </p>
    ...
    <div class="effectsContainer">
      ...
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('psychedelic', 'cognitive')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      ...
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('psychedelic', 'physical')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
