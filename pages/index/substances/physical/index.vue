<template>
  <div class="pageContent effectCategories">
    ...
    <div class="effectsContainer">
      <h3> Enhancements </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'enhancement')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Suppressions </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'suppression')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Alterations </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'alteration')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      ...
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'cardiovascule')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Cerebrovascular </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'cerebrovascular')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Bodily </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('physical', 'bodily')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
