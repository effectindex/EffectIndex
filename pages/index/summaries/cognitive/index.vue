<template>
  <div class="pageContent effectCategories">
    ...
    <div class="effectsContainer">
      <h3> Enhancements </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('cognitive', 'enhancement')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Suppressions </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('cognitive', 'suppression')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Novel States </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('cognitive', 'novel')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      ...
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('cognitive', 'psychological state')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Transpersonal States </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('cognitive', 'transpersonal state')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
