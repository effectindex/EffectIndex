<template>
  <div class="pageContent effectCategories">
    ...
    <div class="effectsContainer">
      ...
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'visual')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Auditory Effects </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'auditory')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Tactile States </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'tactile')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Disconnective Effects </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'disconnective')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Smell &amp; Taste Effectss </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'gustatory')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'olfactory')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
    ...
    <div class="effectsContainer">
      <h3> Multisensory Effects </h3>
      <long-summary 
        v-for="(effect, i) in filterEffectsByTag('sensory', 'multisensory')"
        :index="i"
        :effect="effect"
        :key="effect._id" />
    </div>
